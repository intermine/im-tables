# Get the formatter for the given path.
exports.getFormatter = (path) ->
...
# Return true if this path should be formatted in a custom way.
exports.shouldFormat = (path, formatSet) ->
