  ...
  defaults() {
    return {
      ...
      TableResults: {
        CacheFactor: 10,
        RequestLimit: 5000
      }, // Dump the cache rather than request more rows than this
      TableHeader: {
      ...
      }, // Set to true to show all subtables by default.
      Facets: {
        DrawAverageLine: true,
        Initially: {
          Open: true
        }
      }, // set to false to show them closed, initially.
      ...
      Destination: {
        ...
        Galaxy: {
          ...
          Save: false,
          Enabled: true
        }, // Set this to false to disable this export destination
        GenomeSpace: {
        ...
        Drive: {
          ...
          Enabled: false
        }, // To enable, set this to true and provide auth.drive
        Dropbox: {
          Library: 'https://www.dropbox.com/static/api/2/dropins.js',
          Enabled: false
        }
      }, // To enable, set this to true and provide auth.dropbox
      ShowId: false,
